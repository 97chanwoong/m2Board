                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <div class="form-group">
                                    	...
                                    	<input type="text" class="form-control" placeholder="Enter Id..." name="idck" id="idck">
                                    </div>
                                    <div class="form-group" >
										<button type="button"  id="idckBtn"  class="btn btn-primary">아이디 중복검사</button>
									</div>
                                    <form id="addMemberForm" action="<%=request.getContextPath()%>/addMember" method="post">
                                        <div class="form-group">
                                            <label><strong>아이디</strong></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="password" class="form-control" name="memberPw" id="memberPw" placeholder="Enter Password...">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="text-center mt-4">
                                            ...
                                            <a href="${pageContext.request.contextPath}/login" type="button" class="btn btn-primary btn-block">돌아가기</a>
                                        </div>
                                        <div id="layer"
