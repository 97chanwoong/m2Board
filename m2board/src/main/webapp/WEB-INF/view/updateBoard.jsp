                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                   <form id="updateBoardBtn" action="<%=request.getContextPath()%>/updateBoard" method="post">
										<table class="table student-data-table m-t-10">
											...
											<tr>
												<th>내용</th>
												<td>
													<textarea rows="5" cols="100" name="boardContents"></textarea>
												</td>
											</tr>
										</table>
										<div style="text-align:right;">
										<button id="updateBtn" class="btn btn-primary" type="submit">작성</button>
                                    	</div>
                                    </form>
                                     <div>
                                     <ul class="pagination">
